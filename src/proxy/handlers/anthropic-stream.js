...
export class AnthropicStreamProcessor {
    ...
    _onContentBlockDelta(tmp0, tmp1) {
        ...
        if (tmp2.type === "text_delta" && tmp2.text) {
            ...
            tmp1.push(buildThinkingDelta(this._messageId, tmp2.thinking, this._chunkCtx));
    ...
    _onContentBlockStop(tmp0, tmp1) {
        if (this._currentBlockType === "text") {
            ...
            tmp1.push(buildToolCallDelta(this._messageId, [tmp12], this._chunkCtx));
            ...
            tmp1.push(buildSignatureDelta(this._messageId, this._signatureBuffer, this._chunkCtx));
            this._signatureBuffer = "";
        }
        this._currentBlockType = null;
        this._currentBlockIndex = -1;
    ...
    _onMessageStop(tmp0) {
        ...
        tmp0.push(buildStopChunk(this._messageId, tmp1, this._modelUid, this._chunkCtx));
